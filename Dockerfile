...
#COPY phpmyadmin.conf /server-confs/phpmyadmin.conf
...
ENV ADDITIONAL_MODULES php7-mysqli php7-session php7-ctype php7-json php7-mbstring php7-zip php7-gd php7-openssl php7-xml
